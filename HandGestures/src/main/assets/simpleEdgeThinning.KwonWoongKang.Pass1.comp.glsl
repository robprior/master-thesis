...
void main() {
    ...
    if (pi.a != 0.0) {
        ...
        // in first sub iteration we check if 2<=BP<=6 and second we check 3<=BP<=6
        bool BPCheck = iteration == 0 ? BP >= 2 : BP >=3;
        BPCheck = BPCheck && BP <= 6;
        ...
        if (AP == 1 && BPCheck && neighCheck1 == 0 && neighCheck2 == 0) {
